...
const CartProduct = ({ id, name, image, category, qty, total, price }) => {
  ...
  return (
    <div className="bg-slate-200 p-2 my-1 flex gap-4 rounded border border-slate-300">
      <div className="p-3 bg-white rounded  overflow-hidden">
        <img src={image} className="h-28 w-40 object-cover  hover:scale-105 transition-all " alt="" />
      </div>
